...
def main():
    ...
    # Save T5 results
    with open(f"t5_results_withragg_256chunk_{timestamp}.json", 'w', encoding='utf-8') as f:
        json.dump({
            "results": t5_results,
    ...
    with open(f"mistral_results_withragg_256chunk_{timestamp}.json", 'w', encoding='utf-8') as f:
        json.dump({
    ...
    # Save Qwen results
    with open(f"qwen_results_withrag_256chunk_{timestamp}.json", 'w', encoding='utf-8') as f:
        json.dump({
